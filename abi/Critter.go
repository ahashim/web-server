...
// FilterAccountCreated is a free log retrieval operation binding the contract event 0xb3202828e8e55b43ee1a77a1ee6ffbe19f0205767feb21e28cadd26390ff0501.
//
// Solidity: event AccountCreated(address account, string username)
func (_Critter *CritterFilterer) FilterAccountCreated(opts *bind.FilterOpts) (*CritterAccountCreatedIterator, error) {

	logs, sub, err := _Critter.contract.FilterLogs(opts, "AccountCreated")
	if err != nil {
		return nil, err
	}
...
// WatchAccountCreated is a free log subscription operation binding the contract event 0xb3202828e8e55b43ee1a77a1ee6ffbe19f0205767feb21e28cadd26390ff0501.
//
// Solidity: event AccountCreated(address account, string username)
func (_Critter *CritterFilterer) WatchAccountCreated(opts *bind.WatchOpts, sink chan<- *CritterAccountCreated) (event.Subscription, error) {

	logs, sub, err := _Critter.contract.WatchLogs(opts, "AccountCreated")
	if err != nil {
		return nil, err
	}
...
// ParseAccountCreated is a log parse operation binding the contract event 0xb3202828e8e55b43ee1a77a1ee6ffbe19f0205767feb21e28cadd26390ff0501.
//
// Solidity: event AccountCreated(address account, string username)
